...
namespace Sistema_de_Registracion_de_Viajes
{
    ...
    {
        protected CLSEmpleado(string user, string password, string nombre, string apellido, int dni, DateTime fecha_nacimiento, string direccion, int telefono, string correo)
